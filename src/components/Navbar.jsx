...
const Navbar = () => {
  ...
  return (
    <nav className='w-full mr-0 sm:w-1/3 flex flex-col sm:flex-row sm:justify-between font-semibold sm:mr-36 items-center'>
        <Link className={`${pathname === '/' ? 'bg-slate-50 rounded-md text-black ease-out' : 'text-slate-50'} py-2 px-4 hover:text-black`} to="/">Prediccion &#128187;</Link>
